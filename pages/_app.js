...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Harsh Vardhan";
	const description =
		"Hello! I'm Harsh Vardhan, a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar = "/assets/company/avatar.png"; 
	const url = "";
